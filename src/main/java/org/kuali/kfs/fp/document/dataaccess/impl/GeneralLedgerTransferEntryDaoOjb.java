...
public class GeneralLedgerTransferEntryDaoOjb extends PlatformAwareDaoBaseOjb implements GeneralLedgerTransferEntryDao {
    private static final Logger LOG = LogManager.getLogger(GeneralLedgerTransferEntryDaoOjb.class);
    ...
    private Criteria createGeneralLedgerTransferEntryPrimaryKeyMap(
        ...
        LOG.info("createGeneralLedgerTransferEntryPrimaryKeyMap: criteria is ====> " + criteria.toString() + "<====");
        return criteria;
    }
